...
> [!TIP]
>
> Location within the framework `smith-agent-framework/tools`.
...
import { ArXivTool } from "smith-agent-framework/tools/arxiv";
...
} from "smith-agent-framework/tools/base";
import { z } from "zod";
...
import { z } from "zod";
import { createURLParams } from "smith-agent-framework/internals/fetcher";
import { GetRunContext } from "smith-agent-framework/context";
import { Callback, Emitter } from "smith-agent-framework/emitter/emitter";
...
```ts
import { DynamicTool, StringToolOutput } from "smith-agent-framework/tools/base";
import { z } from "zod";
...
import { CustomTool } from "smith-agent-framework/tools/custom";
