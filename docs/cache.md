...
> [!TIP]
>
> Location within the framework `Smith-agent-framework/cache`.
...
```ts
import { Cache } from "Smith-agent-framework/cache/decoratorCache";
...
```ts
import { Cache, SingletonCacheKeyFn } from "Smith-agent-framework/cache/decoratorCache";
...
```ts
import { CacheFn } from "Smith-agent-framework/cache/decoratorCache";
...
```ts
import { BaseCache } from "Smith-agent-framework/cache/base";
